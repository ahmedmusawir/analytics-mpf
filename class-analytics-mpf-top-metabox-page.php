...
*/
class Analytics_MPF_Top_Metabox_Page 
{
    ...
    ?>
         ...
         <textarea class="widefat" name="analytics_top_page_metabox" rows="7"><?php echo $value; ?></textarea>
    ...
    public function saveMetaboxTextArea( $post_id )    {
        ...
        if ( array_key_exists( 'analytics_top_page_metabox', $_POST ) ) {        
            /**
             *
             * update post meta 
             ...
             *
             */
            $textarea_content = $_POST[ 'analytics_top_page_metabox' ];
            // $textarea_content = sanitize_text_field( $_POST[ 'analytics_top_page_metabox' ] );

            update_post_meta( 
                $post_id,                                              // Post ID
                '_analytics_top_page_meta_key',                              // Meta key            
