...
*/
class Analytics_MPF_Middle_Metabox_Post 
{
    ...
    ?>
         ...
         <textarea class="widefat" name="analytics_middle_metabox" rows="7"><?php echo $value; ?></textarea>
    ...
    public function saveMetaboxTextArea( $post_id )    {
        ...
        if ( array_key_exists( 'analytics_middle_metabox', $_POST ) ) {        
             ...
             *
             */
            $textarea_content = $_POST[ 'analytics_middle_metabox' ];
