...
*/
class Analytics_MPF_Bottom_Metabox 
{
    ...
    ?>
         ...
         <textarea class="widefat" name="analytics_bottom_metabox"><?php echo $value; ?></textarea>
    ...
    public function saveMetaboxTextArea( $post_id )    {
        ...
        if ( array_key_exists( 'analytics_bottom_metabox', $_POST ) ) {        
             ...
             *
             */
            $textarea_content = sanitize_text_field( $_POST[ 'analytics_bottom_metabox' ] );
