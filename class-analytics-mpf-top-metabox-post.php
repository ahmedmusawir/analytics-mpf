...
*/
class Analytics_MPF_Top_Metabox_Post 
{
    ...
    ?>
         ...
         <textarea class="widefat" name="analytics_top_metabox" rows="7"><?php echo $value; ?></textarea>
    ...
    public function saveMetaboxTextArea( $post_id )    {
        ...
        if ( array_key_exists( 'analytics_top_metabox', $_POST ) ) {        
             ...
             *
             */
            $textarea_content = $_POST[ 'analytics_top_metabox' ];
